...
const STOPWORDS = new Set([
  ...
  'so', 'than', 'that', 'the', 'their', 'them', 'they', 'this', 'to', 'was', 'were',
  'while', 'will', 'with',
]);

const NEGATIONS = new Set([
  'not', 'no', 'never', 'none', 'cannot', 'cant', 'wont', 'dont', 'doesnt', 'didnt',
  'isnt', 'arent', 'wasnt', 'werent', 'longer', // "no longer" — "no" also matches alone
]);
...
const POLARITY_AXES: { axis: string; groups: string[][] }[] = [
  {
    axis: 'direction',
    groups: [
      ['raise', 'raised', 'raises', 'raising', 'increase', 'increased', 'increases', 'hike', 'hiked', 'hikes', 'grew', 'grow', 'grows'],
      ['lower', 'lowered', 'lowers', 'cut', 'cuts', 'decrease', 'decreased', 'decreases', 'drop', 'dropped', 'drops', 'reduce', 'reduced', 'reduces'],
  ...
  },
  {
    axis: 'lifecycle',
    groups: [
      ['launch', 'launched', 'launches', 'release', 'released', 'releases', 'introduce', 'introduced', 'introduces', 'ship', 'shipped', 'ships'],
      ['discontinue', 'discontinued', 'discontinues', 'sunset', 'sunsets', 'deprecate', 'deprecated', 'deprecates', 'retire', 'retired', 'retires', 'cancel', 'cancelled', 'canceled', 'cancels', 'kill', 'kills', 'killed'],
    ],
  },
  {
    axis: 'stance',
    groups: [
      ['confirm', 'confirmed', 'confirms', 'acknowledge', 'acknowledged', 'acknowledges', 'admits', 'admitted'],
      ['deny', 'denied', 'denies', 'dispute', 'disputed', 'disputes', 'refute', 'refuted', 'refutes', 'reject', 'rejected', 'rejects', 'retract', 'retracted', 'retracts'],
    ],
  },
  {
    axis: 'cost',
